...
describe('TC001 - Verify user is able to filter product by brand', () => {
    it(`Land to "${testData.url}"`, async () => {
        ...
        await expect(landingPage.$header()).withContext('Expect u to the landing page').toBeDisplayed();
    });
    ...
    it('VerifyRefine the listing of product by filtering the brands by selecting the "Samsung" brand name checkbox in "Shop by Brand" shown on the left side of the page', async () => {
...
describe('TC002 -Verify pop up window is displayed', () => {
    it(`Land to to "${testData.url}"`, async () => {
        await landingPage.loadUrl();
        await expect(landingPage.$header()).withContext('Expect user should land to the landing page').toBeDisplayed();
    });
    ...
    it('Navigate to "Component" page using menu option', async () => {
        ...
        await expect(landingPage.$componentHeader()).withContext('Expect header should displayed successfully').toBeDisplayed();
    });
    ...
    it("Click in the 'Learn more' link on the 'Pop Window Component' tile", async () => {
        ...
        await expect(componentPage.$commonButton("Open Pop Window")).withContext('Expect Header should displyaed successfully').toBeDisplayed();
    });

    it("Click on the 'Open Pop Window' button and verify the pop up window is opened", async () => {
        await componentPage.clickPopUpButton();
        await expect(componentPage.$popUpHeader()).withContext('Expect Header should displyaed successfully').toBeDisplayed();
    });
...
describe('TC004 - Verify if the user is able to search the product using the search bar', () => {
    ...
    it('In the home page, search for a product "Dell XPS 13" in the search bar', async () => {
...
describe('TC005- Verify if the user is able to  click on "Shop now" option ', () => {
    ...
    it('Click on any "Samsung Galaxy S22 Ultra" from "New arrived" section', async () => {
        ...
        await expect(landingPage.$header()).withContext('Expect Expect user should land to the landing page').toBeDisplayed();
    })
    it('In home page, click on shop now button for "Laptop Sale"', async () => {
